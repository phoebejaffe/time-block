...
export function DisableBlockIcon({ crossedOut = false }: { crossedOut?: boolean }) {
  return (
    ...
    >
      {crossedOut ? (
        <>
          <path d="M12 2C16.714 2 19.071 2 20.536 3.464C22 4.929 22 7.286 22 12C22 16.714 22 19.071 20.536 20.536C19.071 22 16.714 22 12 22C7.286 22 4.929 22 3.464 20.536C2 19.071 2 16.714 2 12C2 7.286 2 4.929 3.464 3.464C4.929 2 7.286 2 12 2Z" />
          <path d="M4 20L20 4" strokeWidth="2.25" />
        </>
      ) : (
        <>
          <path d="M22 10.5V12C22 16.714 22 19.0711 20.5355 20.5355C19.0711 22 16.714 22 12 22C7.28595 22 4.92893 22 3.46447 20.5355C2 19.0711 2 16.714 2 12C2 7.28595 2 4.92893 3.46447 3.46447C4.92893 2 7.28595 2 12 2H13.5" />
          <path d="M22 2L17 7M17 2L22 7" />
        </>
      )}
    </svg>
  )
...
/** Same library mark as LibraryIcon, with a + in the top-right corner. */
...
/** Notebook with text lines — block note (Google Calendar description). */
